...
input_fastadir="/global/scratch/projects/fc_wolflab/bbioinfo/empchase/anvio_test/B_theta_test_2/"
output_dir="/global/scratch/projects/fc_wolflab/bbioinfo/empchase/checkm_test/checkm_ref_results"
...
checkm lineage_wf -x fna "$input_fastadir" "$output_dir"
